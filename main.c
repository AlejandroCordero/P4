...
const enum fsmStates {zero, start, stop, lap};
volatile enum fsmState = zero;									 // fsmState is declared as "volatile" because it's a global variable modified by an ISR.
